 ...
 */
final class Version20190809215321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD property_id INT DEFAULT NULL, DROP property');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD property VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP property_id');
    }
}
